...
`timescale 1 ps / 1 ps
module dmasoc_system_msgdma_0 (
		output wire [31:0]  mm_read_address,              //          mm_read.address
		output wire         mm_read_read,                 //                 .read
		output wire [1:0]   mm_read_byteenable,           //                 .byteenable
		input  wire [15:0]  mm_read_readdata,             //                 .readdata
		...
		output wire [15:0]  st_source_data,               //        st_source.data
		...
		output wire         st_source_empty               //                 .empty
	);

// dmasoc_system_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module dmasoc_system_mm_interconnect_0 (
	...
	wire   [20:0] msgdma_0_csr_agent_m0_address;                                 // msgdma_0_csr_agent:m0_address -> msgdma_0_csr_translator:uav_address
	...
	wire  [114:0] msgdma_0_csr_agent_rf_source_data;                             // msgdma_0_csr_agent:rf_source_data -> msgdma_0_csr_agent_rsp_fifo:in_data
	...
	wire  [114:0] msgdma_0_csr_agent_rsp_fifo_out_data;                          // msgdma_0_csr_agent_rsp_fifo:out_data -> msgdma_0_csr_agent:rf_sink_data
	...
	wire   [20:0] msgdma_0_descriptor_slave_agent_m0_address;                    // msgdma_0_descriptor_slave_agent:m0_address -> msgdma_0_descriptor_slave_translator:uav_address
	...
	wire  [222:0] msgdma_0_descriptor_slave_agent_rf_source_data;                // msgdma_0_descriptor_slave_agent:rf_source_data -> msgdma_0_descriptor_slave_agent_rsp_fifo:in_data
	...
	wire  [222:0] msgdma_0_descriptor_slave_agent_rsp_fifo_out_data;             // msgdma_0_descriptor_slave_agent_rsp_fifo:out_data -> msgdma_0_descriptor_slave_agent:rf_sink_data
	...
	wire  [113:0] msgdma_0_csr_agent_rp_data;                                    // msgdma_0_csr_agent:rp_data -> router_002:sink_data
	...
	wire  [221:0] msgdma_0_descriptor_slave_agent_rp_data;                       // msgdma_0_descriptor_slave_agent:rp_data -> router_003:sink_data
	...
	wire          cmd_mux_src_valid;                                             // cmd_mux:src_valid -> msgdma_0_csr_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_src_data;                                              // cmd_mux:src_data -> msgdma_0_csr_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                             // msgdma_0_csr_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                           // cmd_mux:src_channel -> msgdma_0_csr_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                     // cmd_mux:src_startofpacket -> msgdma_0_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                       // cmd_mux:src_endofpacket -> msgdma_0_csr_burst_adapter:sink0_endofpacket
	wire          msgdma_0_csr_burst_adapter_source0_valid;                      // msgdma_0_csr_burst_adapter:source0_valid -> msgdma_0_csr_agent:cp_valid
	wire  [113:0] msgdma_0_csr_burst_adapter_source0_data;                       // msgdma_0_csr_burst_adapter:source0_data -> msgdma_0_csr_agent:cp_data
	wire          msgdma_0_csr_burst_adapter_source0_ready;                      // msgdma_0_csr_agent:cp_ready -> msgdma_0_csr_burst_adapter:source0_ready
	wire    [1:0] msgdma_0_csr_burst_adapter_source0_channel;                    // msgdma_0_csr_burst_adapter:source0_channel -> msgdma_0_csr_agent:cp_channel
	...
	wire  [221:0] msgdma_0_descriptor_slave_burst_adapter_source0_data;          // msgdma_0_descriptor_slave_burst_adapter:source0_data -> msgdma_0_descriptor_slave_agent:cp_data
	...
	wire    [1:0] msgdma_0_descriptor_slave_burst_adapter_source0_channel;       // msgdma_0_descriptor_slave_burst_adapter:source0_channel -> msgdma_0_descriptor_slave_agent:cp_channel
	...
	wire  [221:0] router_003_src_data;                                           // router_003:src_data -> msgdma_0_descriptor_slave_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                          // msgdma_0_descriptor_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                        // router_003:src_channel -> msgdma_0_descriptor_slave_rsp_width_adapter:in_channel
	...
	wire          msgdma_0_descriptor_slave_rsp_width_adapter_src_valid;         // msgdma_0_descriptor_slave_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [113:0] msgdma_0_descriptor_slave_rsp_width_adapter_src_data;          // msgdma_0_descriptor_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          msgdma_0_descriptor_slave_rsp_width_adapter_src_ready;         // rsp_demux_001:sink_ready -> msgdma_0_descriptor_slave_rsp_width_adapter:out_ready
	wire    [1:0] msgdma_0_descriptor_slave_rsp_width_adapter_src_channel;       // msgdma_0_descriptor_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          msgdma_0_descriptor_slave_rsp_width_adapter_src_startofpacket; // msgdma_0_descriptor_slave_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          msgdma_0_descriptor_slave_rsp_width_adapter_src_endofpacket;   // msgdma_0_descriptor_slave_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          cmd_mux_001_src_valid;                                         // cmd_mux_001:src_valid -> msgdma_0_descriptor_slave_cmd_width_adapter:in_valid
	wire  [113:0] cmd_mux_001_src_data;                                          // cmd_mux_001:src_data -> msgdma_0_descriptor_slave_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                         // msgdma_0_descriptor_slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                       // cmd_mux_001:src_channel -> msgdma_0_descriptor_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                                 // cmd_mux_001:src_startofpacket -> msgdma_0_descriptor_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                   // cmd_mux_001:src_endofpacket -> msgdma_0_descriptor_slave_cmd_width_adapter:in_endofpacket
	...
	wire  [221:0] msgdma_0_descriptor_slave_cmd_width_adapter_src_data;          // msgdma_0_descriptor_slave_cmd_width_adapter:out_data -> msgdma_0_descriptor_slave_burst_adapter:sink0_data
	...
	wire    [1:0] msgdma_0_descriptor_slave_cmd_width_adapter_src_channel;       // msgdma_0_descriptor_slave_cmd_width_adapter:out_channel -> msgdma_0_descriptor_slave_burst_adapter:sink0_channel
	...
	wire          msgdma_0_descriptor_slave_agent_rdata_fifo_out_valid;          // msgdma_0_descriptor_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire  [129:0] msgdma_0_descriptor_slave_agent_rdata_fifo_out_data;           // msgdma_0_descriptor_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          msgdma_0_descriptor_slave_agent_rdata_fifo_out_ready;          // avalon_st_adapter_001:in_0_ready -> msgdma_0_descriptor_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                             // avalon_st_adapter_001:out_0_valid -> msgdma_0_descriptor_slave_agent:rdata_fifo_sink_valid
	wire  [129:0] avalon_st_adapter_001_out_0_data;                              // avalon_st_adapter_001:out_0_data -> msgdma_0_descriptor_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                             // msgdma_0_descriptor_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                             // avalon_st_adapter_001:out_0_error -> msgdma_0_descriptor_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~msgdma_0_reset_n_reset_bridge_in_reset_reset),            //        clk_reset.reset_n
	...
	dmasoc_system_mm_interconnect_0_router router (
	...
	dmasoc_system_mm_interconnect_0_router router_001 (
	...
	dmasoc_system_mm_interconnect_0_router_002 router_002 (
	...
	dmasoc_system_mm_interconnect_0_router_003 router_003 (
	...
	dmasoc_system_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pll_0_outclk0_clk),                                        //        clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset),             //  clk_reset.reset
	...
	dmasoc_system_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (pll_0_outclk0_clk),                                        //        clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset),             //  clk_reset.reset
	...
	dmasoc_system_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pll_0_outclk0_clk),                            //       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dmasoc_system_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (pll_0_outclk0_clk),                            //       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dmasoc_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pll_0_outclk0_clk),                            //       clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dmasoc_system_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (pll_0_outclk0_clk),                                             //       clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset),                  // clk_reset.reset
	...
	dmasoc_system_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pll_0_outclk0_clk),                            //       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dmasoc_system_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (pll_0_outclk0_clk),                            //       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dmasoc_system_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	dmasoc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (130),
		.inUsePackets    (0),
		.inDataWidth     (130),
		.inChannelWidth  (0),
